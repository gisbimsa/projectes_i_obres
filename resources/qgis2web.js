...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 20, minZoom: 13, projection: new ol.proj.Projection({
            code: 'EPSG:25831',
...
map.getView().fit([415222.100861, 4570248.500674, 441270.845824, 4596297.245637], map.getSize());
